...
public class InfoFresa extends javax.swing.JFrame {
    private static ArrayList<Plaga> listaDePlaga = Plaga.plagas;

    public InfoFresa(String tituloCultivo) {
        initComponents();

        tituloPlaga_Lbl.setText(tituloCultivo);

        nematodosFresa_Btn.addActionListener(new ActionListener() {
        ...
        acarosFresa_Btn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                infoPlaga_txt.setText(listaDePlaga.get(9).getDescripcionPlaga());
                tipoPlaga_Lbl1.setText(listaDePlaga.get(9).getNombrePlaga());
            }
        });

        pulgonesFresa_Btn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
    ...
    private void initComponents() {
        ...
        nematodosFresa_Btn = new javax.swing.JButton();
        volver3_Btn = new javax.swing.JButton();
        acarosFresa_Btn = new javax.swing.JButton();
        pulgonesFresa_Btn = new javax.swing.JButton();
        ...
        nematodosFresa_Btn.setFont(new java.awt.Font("Roboto Medium", 0, 18)); // NOI18N
        nematodosFresa_Btn.setText("Nemátodos");
        ...
        acarosFresa_Btn.setFont(new java.awt.Font("Roboto Medium", 0, 18)); // NOI18N
        acarosFresa_Btn.setText("Ácaros");

        pulgonesFresa_Btn.setFont(new java.awt.Font("Roboto Medium", 0, 18)); // NOI18N
        pulgonesFresa_Btn.setText("Pulgones");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(acarosFresa_Btn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(nematodosFresa_Btn, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE)
                            .addComponent(pulgonesFresa_Btn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(30, 30, 30))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(46, 46, 46)
                .addComponent(nematodosFresa_Btn, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(32, 32, 32)
                .addComponent(acarosFresa_Btn, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(31, 31, 31)
                .addComponent(pulgonesFresa_Btn, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void productos_BtnActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ...
        if (tipoPlaga_Lbl1.getText() == "Nemátodo") {
            Productos infoFrame = new Productos(listaDePlaga.get(0).getProducto(), "¿Cómo Erradicar los " + listaDePlaga.get(0).getNombrePlaga() + "s?");
            infoFrame.setVisible(true);
            this.dispose();
        } else if (tipoPlaga_Lbl1.getText() == "Ácaros") {
            Productos infoFrame = new Productos(listaDePlaga.get(9).getProducto() , "¿Cómo Erradicar los " + listaDePlaga.get(9).getNombrePlaga() + "?");
            infoFrame.setVisible(true);
            this.dispose();
        } else if (tipoPlaga_Lbl1.getText() == "Pulgones") {
            Productos infoFrame = new Productos(listaDePlaga.get(6).getProducto(), "¿Cómo Erradicar a los " + listaDePlaga.get(6).getNombrePlaga() + "?");
            infoFrame.setVisible(true);
            this.dispose();
        }
    ...
    private javax.swing.JButton acarosFresa_Btn;
    private javax.swing.JTextPane infoPlaga_txt;
    private javax.swing.JPanel jPanel1;
    private javax.swing.JPanel jPanel2;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JButton pulgonesFresa_Btn;
    ...
    private javax.swing.JButton nematodosFresa_Btn;
